...
function HelpSection({ title, children }) {
  const styles = getHelpStyles();

  return (
    <section className="help-section mt-6 grid gap-2 first:mt-0">
      <p className="help-section-title m-0 text-base font-bold" style={styles.sectionTitle}>
        ── {title} ──
      </p>
      {children}
    </section>
...
export function HelpPage() {
  ...
  return (
    <main className="app-main">
      <article
        className="help-page grid max-w-[672px] gap-4 border px-5 py-5 text-base"
        style={styles.page}
      >
        <h1 className="sr-only">Help</h1>
        <div className="help-page-header grid gap-2">
          <p className="help-page-manual m-0 text-xl font-bold" style={styles.manual}>
            ARTCTL
          </p>
          <p className="help-page-subtitle m-0" style={styles.subtitle}>
            Public-domain artwork explorer
          </p>
        </div>

        <HelpSection title="Gallery">
          <p className="help-page-copy m-0" style={styles.copy}>
